...
## Acceptance Criteria
- [x] A real `tools.files.write` through the wire shows the written path in `locations`
- [x] The tier-2 proof 3 asserts `locations` and stays green

## Review Findings (2026-09-03 10:45)
